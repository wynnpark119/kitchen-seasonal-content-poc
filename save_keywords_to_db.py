...
logger = setup_logger("save_keywords_to_db")
...
def main():
    ...
    try:
        ...
        logger.info(f"To save data, call process_apify_results(items, keyword, run_id) for each dataset")
